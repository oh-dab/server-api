...
@DataJpaTest
class FindAllClassroomByTeacherIdRepositoryTestReq {
    ...
    void 선생님_아이디로_반목록_조회() {
        ...
        // then
        Assertions.assertThat(foundClassrooms.get(0).getTeacher().getId()).isEqualTo(1L);
        Assertions.assertThat(foundClassrooms.get(0).getClassroomInfo().getName()).isEqualTo("1반");
        ...
        Assertions.assertThat(foundClassrooms.get(1).getTeacher().getId()).isEqualTo(1L);
        Assertions.assertThat(foundClassrooms.get(1).getClassroomInfo().getName()).isEqualTo("2반");
        Assertions.assertThat(foundClassrooms.get(1).getClassroomInfo().getDescription())
                .isEqualTo("2반 설명");
        Assertions.assertThat(foundClassrooms.get(1).getClassroomInfo().getGrade())
                .isEqualTo(Grade.HIGH_1);
    }
}
