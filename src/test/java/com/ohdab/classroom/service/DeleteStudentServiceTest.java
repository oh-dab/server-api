        ...
        class ifClassroomExist {
            ...
            class ifActiveStudent {
                ...
                void removeAndExpulsion() {
                    ...
                    final DeleteStudentDto.Request requestDto = DeleteStudentDto.Request.builder()
                    ...
                    final Member student = Member.builder()
            ...
            class ifNotInClassroom {
                ...
                void throwNoStudentException() {
                    ...
                    when(memberRepository.findById(anyLong()))
                            .thenReturn(Optional.ofNullable(student));
                    Throwable thrown = catchException(() -> deleteStudentUsecase.deleteStudent(classroomId, studentId));
