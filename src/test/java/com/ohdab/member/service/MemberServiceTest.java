...
public class MemberServiceTest {
    ...
    void 선생님_목록_조회_성공() {
        // given
        List<MemberDto> teachers = new ArrayList<>();
    ...
    private MemberDto createTeacher(String name, String password) {
        List<String> authorities = new ArrayList<>();
        authorities.add("TEACHER");
        return MemberDto.builder().name(name).password(password).authorities(authorities).build();
    }
}
